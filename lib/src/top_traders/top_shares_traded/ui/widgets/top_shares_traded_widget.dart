...
import '../../repository/top_shares_traded_repository.dart';

class TopSharesTradedWidget extends StatelessWidget {
  const TopSharesTradedWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer(
      builder: (BuildContext context, WidgetRef ref, Widget? child) {
        var response = ref.watch(fetchTopSharesTraded);
